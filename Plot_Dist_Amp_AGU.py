...
mindist=475
maxdist=525
fname=prefix+str(mindist)+'_'+str(maxdist)+'.txt';
ax=plt.subplot(111)
line1=PlotFile(fname, ax=ax, FMT='bs', x=3, y1=4, y2=None, err1=None, err2=None, lw=10, markersize=20)
mindist=1075
maxdist=1125
fname=prefix+str(mindist)+'_'+str(maxdist)+'.txt';
line2=PlotFile(fname, ax=ax, FMT='g^', x=3, y1=4, y2=None, err1=None, err2=None, lw=10, markersize=20)
mindist=1675
maxdist=1725
fname=prefix+str(mindist)+'_'+str(maxdist)+'.txt';
line3=PlotFile(fname, ax=ax, FMT='ro', x=3, y1=4, y2=None, err1=None, err2=None, lw=10, markersize=20)


ax.legend([line1, line2, line3], ['475 km'+'~ 525 km',\
        '1075 km'+'~ 1125 km', \
        '1675 km'+'~ 1725 km'], loc=0)
plt.title('Amplitude for 10 sec: 1075 km < dist < 1125 km')
plt.ylabel('Amplitude(nm)',fontsize=20)
