...
GeoLst.GetMinVs();
avgak135fname='/lustre/janus_scratch/life9360/EA_MODEL/ses3d_extended_model/ak135EA.mod';
...
outdir='/lustre/janus_scratch/life9360/EA_MODEL/ses3d_final_extended_model'
minlat=15.
maxlat=55.
minlon=70.
maxlon=150.
...
# GeoLst.HorizontalExtensionS(avgfname=avgak135fname, outdir=outdir, dlat=0.5, dlon=0.5,\
#     maxlat=maxlat, minlat=minlat, maxlon=maxlon, minlon=minlon, maxlatM=maxlatM, minlatM=minlatM, maxlonM=maxlonM, minlonM=minlonM);
# GeoLst.HorizontalExtension(avgfname=avgak135fname, outdir=outdir, dlat=0.5, dlon=0.5,\
#     maxlat=maxlat, minlat=minlat, maxlon=maxlon, minlon=minlon);
