...
ax=plt.subplot(111)
line1=PlotFile(fname, ax=ax, FMT='bs', x=3, y1=5, y2=None, err1=None, err2=None, lw=10, markersize=15)
mindist=1075
maxdist=1125
fname=prefix+str(mindist)+'_'+str(maxdist)+'.txt';
line2=PlotFile(fname, ax=ax, FMT='g^', x=3, y1=5, y2=None, err1=None, err2=None, lw=10, markersize=15)
mindist=1675
maxdist=1725
fname=prefix+str(mindist)+'_'+str(maxdist)+'.txt';
line3=PlotFile(fname, ax=ax, FMT='ro', x=3, y1=5, y2=None, err1=None, err2=None, lw=10, markersize=15)
