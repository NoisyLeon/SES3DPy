...
prefix='/lustre/janus_scratch/life9360/EA_postprocessing_AGU/OUTPUT_TravelTime_MAP/Amp_Azi_NKNT.'
degree_sign= u'\N{DEGREE SIGN}'
...
ax=plt.subplot(111)
line1=PlotFile(fname, ax=ax, FMT='bs', x=3, y1=4, y2=None, err1=None, err2=None, lw=10, markersize=25)
minazi=253
maxazi=254
fname=prefix+str(minazi)+'_'+str(maxazi)+'.txt';
line2=PlotFile(fname, ax=ax, FMT='g^', x=3, y1=4, y2=None, err1=None, err2=None, lw=10, markersize=25)
minazi=300
maxazi=301
fname=prefix+str(minazi)+'_'+str(maxazi)+'.txt';
line3=PlotFile(fname, ax=ax, FMT='ro', x=3, y1=4, y2=None, err1=None, err2=None, lw=10, markersize=25)
ax.legend([line1, line2, line3], ['235'+degree_sign+' ~ 236'+degree_sign,\
        '253'+degree_sign+' ~ 254'+degree_sign, \
        '300'+degree_sign+' ~ 301'+degree_sign], loc=0)


plt.ylabel('Amplitude(nm)',fontsize=20)
plt.title('Amplitude: T = 10 sec', fontsize=28)
# plt.ylabel('Ms',fontsize=20)
# plt.title('Surface Wave Magnitude: T = 10 sec',fontsize=28)
