...
# sfield.convert_to_hdf5('../example_for_Kuangdai/snapshot_for_kuangdai.h5', mfname, depth=0, iter0=14000, iterf=14000, diter=10)
# 
...
dset.zero_padding( outfname='../example_for_Kuangdai/snapshot_for_kuangdai.h5', component='vz', minV=2.0, \
                evlo=129.0, evla=41.306, dt=0.05, iter0=14000, iterf=14000, diter=5000)
