...
ax=plt.subplot(111)
line1=PlotFile(fname, ax=ax, FMT='bs', x=3, y1=5, y2=None, err1=None, err2=None, lw=10, markersize=25)
minazi=253
maxazi=254
fname=prefix+str(minazi)+'_'+str(maxazi)+'.txt';
line2=PlotFile(fname, ax=ax, FMT='g^', x=3, y1=5, y2=None, err1=None, err2=None, lw=10, markersize=25)
minazi=300
maxazi=301
fname=prefix+str(minazi)+'_'+str(maxazi)+'.txt';
line3=PlotFile(fname, ax=ax, FMT='ro', x=3, y1=5, y2=None, err1=None, err2=None, lw=10, markersize=25)
